...
- [x] **CHRT-01**: 用户可以选择表格中的一只股票并查看该股票最近 60 个交易日图表。
- [x] **CHRT-02**: 图表可以展示价格走势、MA20 和 MA60。
- [x] **CHRT-03**: 图表可以标记用于筛选的区间高点。
- [x] **CHRT-04**: 图表可以标记 `区间高点 * 0.85` 的阈值线。
- [x] **CHRT-05**: 图表可以标记筹码峰价格。
